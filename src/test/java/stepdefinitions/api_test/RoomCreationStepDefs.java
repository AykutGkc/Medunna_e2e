...
public class RoomCreationStepDefs {
    ...
    public void get_the_response_and_validate() throws JsonProcessingException {
        ...
        //2. Yol: JsonPath ile datayi java objesi olarak alip dogrulama yapiyoruz.
        ...
        assertEquals(200.0+"",jsonPath.getDouble("price")+""); //Data dönüsümü problemi nedeniyle iki datayi da String yaptik
        ...
        //5.Yol: objeMapper+pojo--> tavsiye edilen
